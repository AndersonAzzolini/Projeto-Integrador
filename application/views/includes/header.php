      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Sou Empresa</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?= base_url('admin/login') ?>">Entrar</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="<?= base_url('cadastro') ?>">Cadastrar</a>
            </div>
          </li>
          <a class="nav-link" href="<?= base_url('funcionarios/login')?>">Sou Funcionário</a>
